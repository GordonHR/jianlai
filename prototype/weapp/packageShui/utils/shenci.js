...
/* 有配图的事件 id 集合（与 prototype/packageShui/assets/shenci/、weapp/packageShui/assets/shenci/ 下的文件一一对应）
...
function scWishImg(id){ return SC_IMG_IDS.has(id) ? '/packageShui/assets/shenci/'+id+'.jpg' : ''; }
...
function view(){
  ...
  if(out.phase === 'over'){
    ...
    out.ending = {
      key: s.ending, g: e.g, t: e.t, img: e.img||'',
      d: (e.d||'').split('\n'), poem: e.poem||'',
