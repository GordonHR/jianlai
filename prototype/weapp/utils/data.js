...
const HAS_PORTRAIT = new Set(["aliang","baiye","baize","caoci","chenpingan","chenqingdu","daozu","fozu","lisan","miyu","ningyao","qijingchun","zhoumi","之祠","于玄","五嶽","亚圣","仙尉","仰止","余斗","切韵","刘叉","刘灞桥","刘羡阳","刘重润","初升","南簪","卢白象","君倩","吴霜降","周海镜","周澄","周米粒","姚近之","姜尚真","姜赦","宋集薪","宋雨烧","寇名","小陌","崔东山","崔瀺","崔诚","左右","张山峰","徐远霞","托月山大祖","持剑者","斐然","新妆","曹晴朗","朱敛","朱敛真容","李二","李宝瓶","李希圣","李柳","李槐","杨老头","林守一","柔荑","柳柔","沛湘","火龙真人","牛刀","白莹","稚圭","米裕","绯妃","老秀才","至圣先师","苏心斋","苏稼","荷花庵主","萧愻","董三更","蔡金简","袁首","裴杯","裴钱","谢松花","谢狗","贺小凉","赊月","赵天籁","路人","郑居中","郦彩","郭竹酒","长命","阮秀","陆台","陆沉","陆芝","陈景清","陈暖树","隋右边","隋景澄","顾璨","顾粲","马苦玄","魏晋","魏檗","魏羡","黄庭","黄鸾","齐廷济","齐景龙","龙君"]);
