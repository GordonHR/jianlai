...
const CHARS = {
  ...
  aliang:      { name:'阿良', faction:'剑气长城', hp:4, realm:'十四境', skills:['问剑','无忧'], flagship:true,
  ...
  chenqingdu:  { name:'陈清都', faction:'剑气长城', hp:4, realm:'十四境', skills:['一剑','长城'], flagship:true,
  ...
  '火龙真人': { name:'火龙真人', faction:'散修', hp:4, realm:'止境', skills:['铸剑','火德'], txt:'【铸剑】开局获得专属「本命飞剑·火龙」；【火德】你的装备牌效果对所有角色 +1（趴地峰·张山峰之师）', talent:'机缘' },
  ...
  liujinglong:  { name:'刘景龙', faction:'剑气长城', hp:4, realm:'飞升境', skills:['规矩','守序'], txt:'【规矩】你的「剑气」无视距离；【守序】一名剑气长城队友受伤时，你可替其承 1 点（旧异名「齐景龙」已合并）', talent:'锋芒' },
