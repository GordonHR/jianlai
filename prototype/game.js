...
const CHAR_PATH = {
  'aliang': { path:'jianxiu', realm:'十四境', src:'原著', note:'剑气长城剑修，十四境；本命飞剑「饮者」。游侠剑客，与剑气长城渊源极深' },
  'baiye': { path:'lianqi', realm:'十四境·合道', src:'原著', note:'浩然天下诗剑第一人，读书人合道诗篇证道（十四境·合道），持仙剑太白；诗不尽，剑不绝。太白为仙剑，非本命飞剑。曾提剑援手剑气长城，非长城出身、非纯粹剑修' },
  'baize': { path:'yaozu', realm:'止境', src:'推定', note:'蛮荒大妖，通晓万物' },
  'caoci': { path:'wufu', realm:'止境武夫', src:'原著', note:'武道天才，武道止境；师承裴杯（中土神州女子武夫）。非大骊皇子' },
  'chenpingan': { path:'wufu', realm:'止境武夫', src:'原著', note:'止境武夫 + 剑道证道大剑仙，飞升前最强武夫之一' },
  'chenqingdu': { path:'jianxiu', realm:'十四境', src:'原著', note:'剑气长城老大剑仙，十四境；本命飞剑「浮萍」，合道剑气长城，人间剑道顶点' },
  ...
  'miyu': { path:'jianxiu', realm:'玉璞境', src:'原著', note:'剑气长城米家剑修，玉璞境剑仙，本命飞剑「霞满天」；青萍剑宗首席供奉，曾破境仙人境。对妖特攻' },
  ...
  '周米粒': { path:'lianqi', realm:'练气', src:'推定', note:'落魄山护山供奉/右护法（非严格「弟子」），小吃货、福缘奇佳' },
  ...
  '姜尚真': { path:'jianxiu', realm:'玉璞境', src:'原著', note:'桐叶洲玉圭宗宗主（化名周肥），落魄山首席供奉；本命飞剑仅剩一片柳叶，仙人境杀力。境界口径：玉璞境' },
  ...
  '小陌': { path:'jianxiu', realm:'飞升境', src:'原著', note:'落魄山一等供奉；真身蜘蛛鼅鼄、道号喜烛，**飞升境**。持剑者引入山中当保镖。与谢狗（化名白景）同属落魄山' },
  ...
  '张山峰': { path:'wufu', realm:'止境武夫', src:'原著', note:'趴地峰火龙真人**之徒**；对战卡挂中土文庙为阵营压缩' },
  ...
  '持剑者': { path:'jianxiu', realm:'十四境', src:'原著', note:'旧天庭五至高之一、万剑之源，本身即是剑道规则之化身。**非剑气长城出身**；佩剑/神物「老剑条」后认主陈平安。卡池阵营用「散修」压缩' },
  ...
  '斐然': { path:'lianqi', realm:null, src:'推定', note:'蛮荒一侧人物（切韵师弟/同门）；与中土文庙无关，境界未载。卡池阵营取蛮荒以对齐十四王座叙事' },
  '朱敛': { path:'wufu', realm:'止境武夫', src:'推定', note:'落魄山二掌柜，武止境' },
  '李二': { path:'wufu', realm:'止境武夫', src:'推定', note:'李槐之父、李柳之父（非李宝瓶之父）；陈平安武道引路人之一，青童天君杨老头弟子' },
  '李宝瓶': { path:'lianqi', realm:'练气', src:'推定', note:'年轻一代，文圣一脉' },
  '李希圣': { path:'lianqi', realm:'止境', src:'推定', note:'李宝瓶长兄（非大伯），山崖书院读书人；护妹如命，教陈平安画符' },
  '李柳': { path:'lianqi', realm:'十四境·合道', src:'原著', note:'旧天庭水神转世，合道水运；李二之女' },
  '李槐': { path:'lianqi', realm:'练气', src:'推定', note:'同乡少年' },
  '杨老头': { path:'lianqi', realm:'飞升境', src:'原著', note:'青童天君，骊珠洞天/落魄山暗线布局者；郑大风之师、李二之师。非中土文庙儒修' },
  ...
  '火龙真人': { path:'lianqi', realm:null, src:'原著', note:'趴地峰火龙真人，火德一脉，**张山峰之师**。卡内「本命飞剑·火龙」为对战机制名。禁止与铸剑师阮邛混写' },
  '稚圭': { path:'lianqi', realm:'止境', src:'推定', note:'骊珠洞天女子，止境（与玉圭宗、人物「玉圭」无关）' },
  ...
  '蔡金简': { path:'jianxiu', realm:'止境', src:'原著', note:'正阳山剑修；骊珠洞天为夺机缘斩断陈平安长生桥' },
  '裴杯': { path:'wufu', realm:null, src:'原著', note:'中土神州女子武夫，**曹慈之师**（非炼气士）；境界未载。技能「杯」为卡牌机制' },
  '裴钱': { path:'wufu', realm:'止境武夫', src:'原著', note:'落魄山开山大弟子，陈平安弟子；**止境武夫**' },
  '谢松花': { path:'lianqi', realm:'止境', src:'推定', note:'北俱芦洲女子止境' },
  '谢狗': { path:'jianxiu', realm:'飞升境', src:'原著', note:'化名白景，落魄山一等供奉；**飞升境**剑修，两把本命飞剑（名未载）。与小陌同在落魄山' },
  ...
  '郭竹酒': { path:'jianxiu', realm:'金丹境', src:'原著', note:'剑气长城郭稼之女，小名绿端，先天剑胚；陈平安弟子，落魄山与裴钱同门。手持两把本命飞剑（名未载）' },
  '长命': { path:'lianqi', realm:'止境', src:'推定', note:'止境女修' },
  '阮秀': { path:'lianqi', realm:'止境', src:'推定', note:'骊珠洞天铸剑师阮邛之女，炼器火属；与上古火神/神性归位线相关。非「火龙真人」，亦无独立本命飞剑（卡内临时铸剑为游戏机制）' },
  '阮邛': { path:'lianqi', realm:null, src:'原著', note:'骊珠洞天大铸剑师、阮秀之父；兵家圣人路数。铸剑师，非「火龙真人」；后龙泉剑宗相关（刘羡阳接任二宗主）' },
  ...
  '顾粲': { path:'lianqi', realm:'止境', src:'原著', note:'泥瓶巷陈平安故交（非徒弟）；书简湖杀孽与问心局核心，后拜入白帝城郑居中门下。显示名顾璨' },
  '马苦玄': { path:'wufu', realm:'止境', src:'推定', note:'原著点名的止境武夫之一' },
  '魏晋': { path:'jianxiu', realm:'止境', src:'原著', note:'风雪庙剑修，左右之徒；佩剑「高烛」为齐家老祖所铸半仙兵（非本命飞剑，常被误归左右）。无事牌原著句：为情所困，剑不得出。风雪庙魏晋' },
  ...
  '袁黄': { path:'wufu', realm:'金身境', src:'原著', note:'藕花福地出身的江湖游侠，铁匠世家子；以诚挚学拳之心打破陈平安不再收徒的规矩，拳风与落魄山行事风格相契' },
  ...
  '郭稼': { path:'jianxiu', realm:'玉璞境', src:'原著', note:'剑气长城郭家剑仙，郭竹酒之父；郭家是当年唯一举家祭奠宁姚父母的家族' },
  '叠嶂': { path:'lianqi', realm:null, src:'原著', note:'剑气长城人物，与陈平安合伙开酒铺' },
  '观照': { path:'jianxiu', realm:null, src:'原著', note:'剑气长城顶层剑修；与陈清都等「问剑托月山」战史相关' },
  '陈淳安': { path:'lianqi', realm:null, src:'原著', note:'大骊末代陪都人物；以命打落刘叉的十四境合道之路' },
  '邵云岩': { path:'lianqi', realm:null, src:'原著', note:'倒悬山一脉，落魄山泉府韦文龙之师' },
  '种秋': { path:'lianqi', realm:null, src:'推定', note:'与落魄山一系相关的原著人物（项目文本已引用）；境界未载' },
  '刘志茂': { path:'lianqi', realm:null, src:'原著', note:'书简湖人物，早年看中顾璨并将其带往书简湖修行' },
  '嫩道人': { path:'lianqi', realm:null, src:'原著', note:'李槐护道人' },
  '邓剑翘': { path:'wufu', realm:null, src:'原著', note:'北俱芦洲女子武夫，邓剑枰之姐' },
  '赵鸾': { path:'lianqi', realm:null, src:'原著', note:'赵树下之妹；胭脂郡旧事相关' },
  '陈对': { path:'lianqi', realm:null, src:'原著', note:'颍阴陈氏；救活刘羡阳并带往南婆娑洲' },
  '离真': { path:'yaozu', realm:null, src:'原著', note:'蛮荒第一天骄；隐官线与陈平安交手' },
  '姚冲道': { path:'jianxiu', realm:null, src:'原著', note:'剑气长城剑修；与阿良联手对付蛮荒王座黄鸾' },
  '顾佑': { path:'wufu', realm:'止境武夫', src:'原著', note:'原著点名的止境武夫之一（与崔诚、马苦玄并列提及）' },
};
...
function startGame(keys, mode){
  ...
  state.players.forEach(pl=>{
    ...
    if(se && !pl['_sk_'+se.n] && !pl.equip){
      markUsed(pl,se);
      const _sw = CHARS[se.n] && CHARS[se.n].sword;
      pl.equip = { uid:++cardUid, type:'equip', name:'本命飞剑' + (_sw ? '·'+_sw : ''), sub:'feijian' };
...
async function playTrick(p, card){
  ...
  if(card.sub==='lianqi'){
    const _sw = CHARS[p.key] && CHARS[p.key].sword;
    p.equip = { uid:++cardUid, type:'equip', name:'本命飞剑' + (_sw ? '·'+_sw : ''), sub:'feijian' };
